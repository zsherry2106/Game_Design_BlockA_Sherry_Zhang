...
def level_3_page(name):
    ...
    #image, x, y
    portal_image_list = [[portal_down_image, 0, HEIGHT - portal_down_image.get_height()], [portal_left_image, 100, 200],
                         [portal_right_image, WIDTH - portal_right_image.get_width(), 200], [portal_down_image, 600, HEIGHT - portal_down_image.get_height()],
                         [portal_down_image, 500, HEIGHT - portal_down_image.get_height()], [portal_right_image, 600 - portal_right_image.get_width(), 0],
                         [portal_down_image, 200, 500 - portal_down_image.get_height()], [portal_right_image, 500 - portal_right_image.get_width(), 0],
                         [portal_up_image, 100, 0], [portal_right_image, WIDTH - portal_right_image.get_width(), 0]
                         ]
    portal_list = []
